...
write_csv(gapminder_column_subset, file = 'gapminder_column_subset.csv')
```
...
<br/>
<hr/>
| [Previous lesson](r-01-introduction.html) | [Top of this lesson](#top) | [Next lesson](r-03-exploration-ggplot.html) |
| :--- | :----: | ---: |